...
##En python tambien se pueden enviar n parametros a una funcion y trabajar con ellas:
...
def add_value_aux(*args):
	l = []
	for value in args:
		l.append(value)
	return l

#print(add_value(100,200,300,400,500))
#add_value(100,200)
l_2 = add_value_aux(100,200,300,400,500,600,700,800)
#print(l_2)


#Keywordargumentos(kwargs)
def get_details_dicc(**kwargs):
	diccionario = kwargs
	return diccionario

diccionario = get_details_dicc(name="ABC",email="abc@gmail.com",contact=8745897438,dob="12-05-2019")
print(diccionario)
